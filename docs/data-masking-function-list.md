...
Percona Server for MySQL 8.4.4-1 adds this variable. The number of seconds between a synchronization between the dictionaries table and the internal dictionary cache. The default value is 10,000 seconds (2 hours and 46 minutes). The minimum value is 1 second. The maximum value is 31,536,000 seconds (1 year).
