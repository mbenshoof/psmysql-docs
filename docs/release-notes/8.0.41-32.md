...
* Extends the [Encryption user-defined functions](..//encryption-functions.md) with the following:
     ...
     * `encryption_udf.legacy_padding_scheme` system variable to manage legacy padding schemes
...
* [PS-9612](https://perconadev.atlassian.net/browse/PS-9612): Percona Server build failed if more than 128 threads were available. Percona merged the fix form [MariaDB](https://github.com/MariaDB/server/commit/fd9f1638ea7).
